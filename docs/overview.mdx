...
3. **Captures Learnings from local work** — resolved issues, reviewer
   ...
   advice. Learnings stay on disk in your project, not in a hosted service.
...
5. **Learnings persist** — resolved issues and reviewer feedback become
   on-disk project Learnings, so the next review references your project's
   real patterns instead of generic advice.
